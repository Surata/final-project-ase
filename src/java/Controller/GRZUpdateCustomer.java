 ...
 * @author edista
 */
public class GRZUpdateCustomer extends GRZBaseController {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if(errorText.equals("")){
            Boolean success = service.changeCustomerDetail(id,
                                                        username,
                                                        password, 
                                                        name, 
                                                        email, 
                                                        ...
                                                        status);
            if(success)
                response.sendRedirect(GRZConstant.CUSTOMER_PAGE);
          
        }else{
            errorHandler(GRZConstant.USER_UPDATE_PAGE ,errorText+"&id=" + id, response);
        }
    }
