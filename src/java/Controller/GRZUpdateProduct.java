 ...
 * @author edista
 */
public class GRZUpdateProduct extends GRZBaseController {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if(errorText.equals("")){
           ...
           Boolean success = service.changeProduct(id, name, desc, Float.parseFloat(price), "Image/"+imageURL);
                
           if(success) 
               response.sendRedirect(GRZConstant.PRODUCT_LIST_PAGE);
            
        }else{
            errorHandler(GRZConstant.PRODUCT_UPDATE_PAGE, errorText + "&id="+id, response);
        }
    }
